...
const statusConfig = {
  live: { label: "Live", bg: "bg-gold/10", text: "text-gold", dot: "bg-gold" },
  ...
  return (
    <div>
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-bold text-gold mb-3">Apps I Build</h1>
      ...
      <div className="space-y-4">
        ...
        {error && (
          <div className="text-center py-8 text-muted text-sm">
            Could not load apps.{" "}
            <a href="https://franciscocucullu.com/apps/" target="_blank" className="text-gold underline">
              View on website
            </a>
          </div>
        )}
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1 mt-1">
                        {app.tags.slice(0, 3).map((tag) => (
                          <span key={tag} className="text-[10px] px-1.5 py-0.5 rounded-full bg-gold/10 text-muted">
                            {tag}
                          </span>
                        ))}
                      </div>
      ...
      <div className="text-center mt-8 mb-4">
        <a href="https://franciscocucullu.com/apps/" target="_blank" className="text-[11px] text-muted/60 hover:text-gold transition-colors">
